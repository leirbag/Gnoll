...
#ifndef __INPUTEVENTSTRANSLATOR_H__
#define __INPUTEVENTSTRANSLATOR_H__
...
namespace Gnoll
{
	namespace Input
	{
		 ...
		 */
		class InputEventsTranslator: public Module, public Gnoll::Core::Singleton<InputEventsTranslator>
		{
			private:
				/**
			...
			public:
				 ...
				 */
				virtual ~InputEventsTranslator();

				/**
				 * @copydoc Module::Module
				 */
				InputEventsTranslator();
