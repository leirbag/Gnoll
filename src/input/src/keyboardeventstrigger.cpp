...
namespace Gnoll
{
	namespace Input
	{
		KeyboardEventsTrigger::KeyboardEventsTrigger( shared_ptr<KeyboardEventsTranslator> _cKeyboardEventsTranslator) :
			m_cKeyboardEventsTranslator(_cKeyboardEventsTranslator)
		{
		}

		KeyboardEventsTrigger::~KeyboardEventsTrigger()
		{
		}

		void KeyboardEventsTrigger::handle(shared_ptr<Message> message)
		{
