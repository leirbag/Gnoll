...
class BaseGnollBuilder:
	...
	def gatherCoreSourceFiles(self, env, config):
		...
		coreSourceFiles = ['src/core/src/cgenericmessagemanager.cpp', 'src/core/src/cmessagetype.cpp', 'src/core/src/attributehandlerregistry.cpp', 'src/core/src/filestream.cpp', 'src/core/src/list.cpp', 'src/core/src/string.cpp', 'src/core/src/persistentobject.cpp', 'src/core/src/persistentobjectmanager.cpp', 'src/core/src/sourcefile.cpp', 'src/core/src/camera.cpp', 'src/core/src/camerafreefly.cpp', 'src/core/src/camerafreeflylistener.cpp', 'src/core/src/camerafirstperson.cpp', 'src/core/src/camerafirstpersonlistener.cpp', 'src/core/src/camerathirdperson.cpp', 'src/core/src/camerathirdpersonlistener.cpp', 'src/core/src/inheritsattributehandler.cpp', 'src/core/src/inherits.cpp', 'src/core/src/cmessagemodule.cpp', 'src/core/src/cameraspline.cpp', 'src/core/src/camerasplinelistener.cpp', 'src/core/src/cpersistentobjectproxy.cpp', 'src/core/src/cpoolthreads.cpp', 'src/core/src/cthreadstopper.cpp', 'src/core/src/cworker.cpp']
